...
import { Heart, HeartCrack, MapPin, XCircle } from 'lucide-react';
...
export default function GreenFlagOffer({ offer, player, onAccept, onReject, onEndGame }: GreenFlagOfferProps) {
